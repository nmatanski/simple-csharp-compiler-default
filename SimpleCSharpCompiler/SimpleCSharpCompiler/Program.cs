...
namespace SimpleCSharpCompiler
{
	class Program
	{
		public static int Main(string[] args)
		{
			...
			if (i >= args.Length)
			{
				Console.WriteLine("Syntax: SimpleCSharpCompiler {/r:filename} <source file> [<result exe file>]");
				Console.WriteLine("Example: SimpleCSharpCompiler /r:System.dll /r:System.Xml.dll examle.scs example.exe");
